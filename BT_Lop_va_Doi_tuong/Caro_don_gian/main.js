...
function Cell (x, y){
    ...
    this.getHTML = function() {
        let top = x * DEFAULT_CEIL_SIZE;
        let left = y * DEFAULT_CEIL_SIZE;
        let cellHTML = `<div id='cell-${x}-${y}' 
            onclick='play(${x}, ${y})' 
            class='cell'
            style='
                position: absolute; 
                width: ${DEFAULT_CEIL_SIZE}px;
                height: ${DEFAULT_CEIL_SIZE}px;
                left: ${left}px;
                top: ${top}px;
                line-height: ${DEFAULT_CEIL_SIZE}px;
                '   
        </div>`;
        return cellHTML;
    };
